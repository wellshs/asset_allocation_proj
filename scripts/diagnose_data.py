...
print(f"  Annualized formula: (1 + total_return)^(252/days) - 1")
print(f"  With 15 days: (1 + return)^(252/15) = (1 + return)^16.8")
print(f"  This exponential amplification creates unrealistic numbers!")
print()
print("=" * 60)
print("SOLUTION")
print("=" * 60)
...
print(f"  start_date=date(2010, 1, 4)")
print(f"  end_date=date(2010, 12, 31)")
print()
